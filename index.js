...
//1.function to store and manage local file storage as json data)
function manageURLdata(action, input) {
  ...
  if (action == 'save data' && input != null) {
    ...
    if (file.length == 0) {
      //add new data to json file if empty
...
function generateshorturl() {
  let all_Data   = manageURLdata('load data');
